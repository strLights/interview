<template><h2 id="webpack构建流程-原理" tabindex="-1"><a class="header-anchor" href="#webpack构建流程-原理" aria-hidden="true">#</a> webpack构建流程（原理）</h2>
<p>从启动构建到输出结果一系列过程：</p>
...
<p>（3）确定入口：从配置的entry入口(fs读取文件内容)，开始解析文件构建AST语法树（ @babel/parser 转AST树），找出依赖，递归下去。</p>
