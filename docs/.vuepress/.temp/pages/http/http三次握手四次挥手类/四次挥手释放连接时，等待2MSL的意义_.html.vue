<template><h1 id="四次挥手释放连接时-等待2msl的意义" tabindex="-1"><a class="header-anchor" href="#四次挥手释放连接时-等待2msl的意义" aria-hidden="true">#</a> 四次挥手释放连接时，等待2MSL的意义?</h1>
...
<li>
<p>防止“已失效的连接请求报文段”出现在本连接中。
客户端在发送完最后一个ACK报文段后，再经过2MSL，就可以使本连接持续的时间内所产生的所有报文段都从网络中消失，使下一个新的连接中不会出现这种旧的连接请求报文段。</p>
</li>
</ol>
<p>延伸</p>
